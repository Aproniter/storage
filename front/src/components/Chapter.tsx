    ...
    return (
        ...
        >
            ...
            <div className='tools flex'>
                ...
                <span className='text-xs mb-1'>документы</span>
                <svg 
                    className='w-8 h-8'
                ...
                {haveNotes && <div className="tool p-1 hover:shadow shadow-2xl items-center flex flex-col" data-tooltip='Показать/скрыть'>
